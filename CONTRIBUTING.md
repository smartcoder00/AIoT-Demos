...
Contributors are expected to base their work on the `main` branch and submit pull requests to `main` branch.
...
1. [Fork](https://github.com/qualcomm/<REPLACE-ME>/fork) and clone the repository.
    ...
    ```bash
    git clone https://github.com/<username>/Startup-Demos.git
    ``` 
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm/Startup-Demos.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm/Startup-Demos/pulls) from your branch to `main`.
